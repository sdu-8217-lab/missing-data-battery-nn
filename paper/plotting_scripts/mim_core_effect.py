...
# ==================== 数据加载与处理 ====================
print("加载数据...")
df = pd.read_csv('../experiment_data/plotting_data_v0.5.csv')
...
def main():
    ...
    # 保存
    output_png = OUTPUT_DIR / 'mim_core_effect.png'
    output_pdf = OUTPUT_DIR / 'mim_core_effect.pdf'
