...
\begin{figure*}[!htb]
    \centering
    \includegraphics[width=\textwidth]{problem_scenario.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\columnwidth]{baseline_vs_mim_comparison.png}
...
\begin{figure*}[!htb]
    \centering
    \includegraphics[width=\textwidth]{joint_training_strategy.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{experimental_flow.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{greedy_ablation.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{architecture_scaling.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{improvement_vs_missing_rate.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{imputation_gradient.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{missing_mechanisms.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{statistical_significance.png}
