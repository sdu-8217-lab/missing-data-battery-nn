...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figure6_experimental_flow.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figure3_imputation_gradient_v2.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figure2_missing_mechanisms_v2.png}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figure5_statistical_significance.png}
