...
\begin{itemize}
    \item \textbf{Training Set (60\%):} 18 batteries, comprising approximately 5,400 cycle samples for model parameter learning.
    \item \textbf{Validation Set (20\%):} 6 batteries, comprising approximately 1,800 cycle samples for hyperparameter tuning and early stopping.
    \item \textbf{Test Set (20\%):} 6 batteries, comprising approximately 1,800 cycle samples reserved exclusively for final performance evaluation.
\end{itemize}
...
\begin{figure}[t]
    ...
    \caption{BMS-oriented model selection decision guide, mapping missing rate intervals to recommended model architectures and MIM configurations. This guide provides practical recommendations for selecting appropriate configurations based on observed data quality and hardware constraints.}
